...
$("#analyzeBtn").on("click", function(){
	...
	console.log("COUNTS", letterCountArray);
...
function renderAnalysis(letterData){
	...
	var selector = d3.select('#analyzePanel')
		.selectAll('div')
		.data(letterData)
	...
	entering.append('div')
		...
		.style("background-color", function(d, i){
			return (i % 2 === 0) ? 'lightblue' : 'lightpink';
		})

		.style("width", function(d, i) { 

			 return (d / sumLetters) * 200 + 4 + "%";
		})

		.text(function(d, i) { 
			return letters[i].toUpperCase() + ": " + d; 
		})
